...
param_basicos  <- list( "cp"=          -0.1,  #complejidad minima
                        "minsplit"=   6262,     #minima cantidad de registros en un nodo para hacer el split
                        "minbucket"=  893,     #minima cantidad de registros en una hoja
...
dtrain  <- fread("~/austral/datasets/paquete_premium_202011.csv")
...
dir.create( "~/austral/labo1/exp/KA2022/", showWarnings = FALSE  )

fwrite( entrega, 
        file= "~/austral/labo1/exp/KA2022/K242_001.csv", 
        sep= "," )
